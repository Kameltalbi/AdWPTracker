        ...
        <div class="adwptracker-ad <?php echo esc_attr(implode(' ', $device_classes)); ?>" 
            ...
            <?php elseif ($type === 'video' && $video_url): ?>
                ...
                if ($video_type === 'youtube') {
                    ...
                    if ($youtube_id) {
                        $embed = '<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%;"><iframe class="adwpt-video-youtube" src="https://www.youtube.com/embed/' . esc_attr($youtube_id) . '?autoplay=1&mute=1&playsinline=1&rel=0&controls=0&enablejsapi=1" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe></div>';
                    }
                    ...
                    $embed = '<video autoplay muted playsinline class="adwpt-video-mp4" style="width: 100% !important; max-width: 100% !important; height: auto !important; display: block !important; margin: 0 !important; padding: 0 !important;"><source src="' . esc_url($video_url) . '" type="video/mp4">Votre navigateur ne supporte pas la vidéo HTML5.</video>';
                }
